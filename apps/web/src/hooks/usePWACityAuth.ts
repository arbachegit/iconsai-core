      ...
      try {
        ...
        if (result.verification_code) {
          try {
            ...
            const smsMessage = `Iconsai Voz PWA City: Seu codigo de verificacao: ${result.verification_code}. Valido por 10 minutos.`;
    ...
    async (params: VerifyParams): Promise<{ success: boolean; error?: string }> => {
      ...
      try {
        ...
        try {
          ...
          const welcomeMessage = `Iconsai Voz PWA City: Ola ${userName}! Bem-vindo ao PWA City. Acesse: https://pwa.iconsai.ai/pwacity`;
