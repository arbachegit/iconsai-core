...
// ============================================
// NORMALIZAÇÃO SIMPLES PARA FALA
// ============================================

// VERSÃO SIMPLIFICADA - apenas pausa natural após pontos finais
function humanizeTextForSpeech(text: string): string {
  // Pausa sutil apenas após pontos finais (não após vírgulas)
    ...
    const response = await fetch(
      `https://api.elevenlabs.io/v1/text-to-speech/${VOICE_ID}/stream`,
      {
        ...
        body: JSON.stringify({
          ...
          voice_settings: {
            stability: 0.50,           // Mais estável = menos cacoetes
            similarity_boost: 0.75,    // Mais claro
            style: 0.20,               // Menos expressivo = menos exageros
