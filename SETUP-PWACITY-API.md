...
3. **Adicione as variáveis necessárias:**
   ...
   **OPENAI_API_KEY:**
   - Nome: `OPENAI_API_KEY`
   - Valor: `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`

   **GOOGLE_GEMINI_API_KEY:**
   - Nome: `GOOGLE_GEMINI_API_KEY`
   - Valor: `AIzaSyA7i1iZfAx6NeUX2mKNGUnYS3JrcJiEdDg`

4. **Clique em "Add secret" para cada variável**

5. **(Opcional) Adicionar outras variáveis que ainda não existem:**
   ```env
   GOOGLE_GEMINI_API_KEY=[quando tiver]
   ELEVENLABS_API_KEY=sk_4dfaf6fc5d29fc4dfaf39f2e2c0deb6af824519e2e52bc44
   TWILIO_ACCOUNT_SID=ACe6922d421ac0013896b2ba90a5e5dcab
   TWILIO_AUTH_TOKEN=41d95b921cc12a2254f00e55b12328db
   ```
