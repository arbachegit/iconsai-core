...
1. **Acesse o Supabase Dashboard:**
   ```
   https://supabase.com/dashboard/project/geaaxpctnixwsppgttsm
   ```
...
3. **Adicione as variáveis necessárias:**
   ...
   **OPENAI_API_KEY:**
   - Nome: `OPENAI_API_KEY`
   - Valor: `[Sua OpenAI API Key - obter em https://platform.openai.com/api-keys]`

   **GOOGLE_GEMINI_API_KEY:**
   - Nome: `GOOGLE_GEMINI_API_KEY`
   - Valor: `[Sua Gemini API Key - obter em https://makersuite.google.com/app/apikey]`
...
1. **Acesse:**
   ```
   https://supabase.com/dashboard/project/geaaxpctnixwsppgttsm/functions
   ```
...
1. **Via Dashboard:**
   ```
   https://supabase.com/dashboard/project/geaaxpctnixwsppgttsm/logs/edge-functions
   ```
...
- **PWA City OpenAI Function:** `https://geaaxpctnixwsppgttsm.supabase.co/functions/v1/pwacity-openai`
- **PWA City Gemini Function:** `https://geaaxpctnixwsppgttsm.supabase.co/functions/v1/pwacity-gemini`
