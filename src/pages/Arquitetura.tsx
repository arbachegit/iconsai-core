      ...
      <div className="relative rounded-2xl overflow-hidden border border-cyan-500/30 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        ...
        <svg viewBox="0 0 1000 280" className="w-full h-auto relative z-10 py-6">
          ...
          <g>
            ...
            <g>
              <animateMotion dur="60s" begin="0s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="0s" repeatCount="indefinite" />
            ...
            <g>
              <animateMotion dur="60s" begin="4s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="4s" repeatCount="indefinite" />
            ...
            <g>
              <animateMotion dur="60s" begin="8s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="8s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
            ...
            <g>
              <animateMotion dur="60s" begin="12s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="12s" repeatCount="indefinite" />
            ...
            <g>
              <animateMotion dur="60s" begin="16s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="16s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
            ...
            <g>
              <animateMotion dur="60s" begin="20s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="20s" repeatCount="indefinite" />
            ...
            <g>
              <animateMotion dur="60s" begin="24s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="24s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
            ...
            <g>
              <animateMotion dur="60s" begin="28s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="28s" repeatCount="indefinite" />
              <rect x="-40" y="-14" width="80" height="28" rx="14" fill="#a855f7" opacity="0.95" />
              <text x="0" y="6" textAnchor="middle" fill="#fff" fontSize="12" fontWeight="600">Palavra</text>
            </g>
            ...
            <g>
              <animateMotion dur="60s" begin="32s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="32s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
                  <MessageCircle className="w-6 h-6 text-pink-300 drop-shadow-[0_0_10px_rgba(236,72,153,0.9)]" />
                </div>
            ...
            <g>
              <animateMotion dur="60s" begin="36s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="36s" repeatCount="indefinite" />
              <rect x="-34" y="-14" width="68" height="28" rx="14" fill="#8b5cf6" opacity="0.95" />
              <text x="0" y="6" textAnchor="middle" fill="#fff" fontSize="12" fontWeight="600">Dados</text>
            </g>
            ...
            <g>
              <animateMotion dur="60s" begin="40s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="40s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
                  <MessageCircle className="w-6 h-6 text-cyan-300 drop-shadow-[0_0_10px_rgba(6,182,212,0.9)]" />
                </div>
            ...
            <g>
              <animateMotion dur="60s" begin="44s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="44s" repeatCount="indefinite" />
              <rect x="-40" y="-14" width="80" height="28" rx="14" fill="#10b981" opacity="0.95" />
              <text x="0" y="6" textAnchor="middle" fill="#fff" fontSize="12" fontWeight="600">PROMPT</text>
            </g>
            ...
            <g>
              <animateMotion dur="60s" begin="48s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="48s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
                  <MessageCircle className="w-6 h-6 text-yellow-300 drop-shadow-[0_0_10px_rgba(253,224,71,0.9)]" />
                </div>
            ...
            <g>
              <animateMotion dur="60s" begin="52s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="52s" repeatCount="indefinite" />
              <rect x="-40" y="-14" width="80" height="28" rx="14" fill="#a855f7" opacity="0.95" />
              <text x="0" y="6" textAnchor="middle" fill="#fff" fontSize="12" fontWeight="600">Palavra</text>
            </g>
            ...
            <g>
              <animateMotion dur="60s" begin="56s" repeatCount="indefinite" fill="freeze">
                <mpath href="#inputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="60s" begin="56s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
                  <MessageCircle className="w-6 h-6 text-pink-300 drop-shadow-[0_0_10px_rgba(236,72,153,0.9)]" />
                </div>
          ...
          <g>
            ...
            {/* Element 1: Sparkles */}
            <g>
              <animateMotion dur="76s" begin="0s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="0s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
            ...
            <g>
              <animateMotion dur="76s" begin="4s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="4s" repeatCount="indefinite" />
            ...
            {/* Element 3: Sparkles */}
            <g>
              <animateMotion dur="76s" begin="8s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="8s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
            ...
            <g>
              <animateMotion dur="76s" begin="12s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="12s" repeatCount="indefinite" />
            ...
            {/* Element 5: Sparkles */}
            <g>
              <animateMotion dur="76s" begin="16s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="16s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
            ...
            <g>
              <animateMotion dur="76s" begin="20s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="20s" repeatCount="indefinite" />
            ...
            {/* Element 7: Sparkles */}
            <g>
              <animateMotion dur="76s" begin="24s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="24s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
                  <Sparkles className="w-6 h-6 text-cyan-300 drop-shadow-[0_0_10px_rgba(6,182,212,0.9)]" />
                </div>
            ...
            <g>
              <animateMotion dur="76s" begin="28s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="28s" repeatCount="indefinite" />
              <rect x="-30" y="-14" width="60" height="28" rx="14" fill="#06b6d4" opacity="0.95" />
              <text x="0" y="6" textAnchor="middle" fill="#0f172a" fontSize="12" fontWeight="600">VALOR</text>
            </g>
            ...
            {/* Element 9: Sparkles */}
            <g>
              <animateMotion dur="76s" begin="32s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="32s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
                  <Sparkles className="w-6 h-6 text-violet-300 drop-shadow-[0_0_10px_rgba(167,139,250,0.9)]" />
                </div>
            ...
            <g>
              <animateMotion dur="76s" begin="36s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="36s" repeatCount="indefinite" />
              <rect x="-40" y="-14" width="80" height="28" rx="14" fill="#8b5cf6" opacity="0.95" />
              <text x="0" y="6" textAnchor="middle" fill="#fff" fontSize="12" fontWeight="600">SOLUÇÃO</text>
            </g>
            ...
            {/* Element 11: Sparkles */}
            <g>
              <animateMotion dur="76s" begin="40s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="40s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
                  <Sparkles className="w-6 h-6 text-pink-300 drop-shadow-[0_0_10px_rgba(236,72,153,0.9)]" />
                </div>
            ...
            <g>
              <animateMotion dur="76s" begin="44s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="44s" repeatCount="indefinite" />
              <rect x="-48" y="-14" width="96" height="28" rx="14" fill="#22d3ee" opacity="0.95" />
              <text x="0" y="6" textAnchor="middle" fill="#0f172a" fontSize="12" fontWeight="600">EFICIÊNCIA</text>
            </g>
            ...
            {/* Element 13: Sparkles */}
            <g>
              <animateMotion dur="76s" begin="48s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="48s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
                  <Sparkles className="w-6 h-6 text-cyan-300 drop-shadow-[0_0_10px_rgba(6,182,212,0.9)]" />
                </div>
            ...
            <g>
              <animateMotion dur="76s" begin="52s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="52s" repeatCount="indefinite" />
              <rect x="-30" y="-14" width="60" height="28" rx="14" fill="#06b6d4" opacity="0.95" />
              <text x="0" y="6" textAnchor="middle" fill="#0f172a" fontSize="12" fontWeight="600">VALOR</text>
            </g>
            ...
            {/* Element 15: Sparkles */}
            <g>
              <animateMotion dur="76s" begin="56s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="56s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
                  <Sparkles className="w-6 h-6 text-violet-300 drop-shadow-[0_0_10px_rgba(167,139,250,0.9)]" />
                </div>
            ...
            <g>
              <animateMotion dur="76s" begin="60s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="60s" repeatCount="indefinite" />
              <rect x="-40" y="-14" width="80" height="28" rx="14" fill="#8b5cf6" opacity="0.95" />
              <text x="0" y="6" textAnchor="middle" fill="#fff" fontSize="12" fontWeight="600">SOLUÇÃO</text>
            </g>
            ...
            {/* Element 17: Sparkles */}
            <g>
              <animateMotion dur="76s" begin="64s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="64s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
                  <Sparkles className="w-6 h-6 text-pink-300 drop-shadow-[0_0_10px_rgba(236,72,153,0.9)]" />
                </div>
            ...
            <g>
              <animateMotion dur="76s" begin="68s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="68s" repeatCount="indefinite" />
              <rect x="-48" y="-14" width="96" height="28" rx="14" fill="#22d3ee" opacity="0.95" />
              <text x="0" y="6" textAnchor="middle" fill="#0f172a" fontSize="12" fontWeight="600">EFICIÊNCIA</text>
            </g>
            ...
            {/* Element 19: Sparkles */}
            <g>
              <animateMotion dur="76s" begin="72s" repeatCount="indefinite" fill="freeze">
                <mpath href="#outputPath" />
              </animateMotion>
              <animate attributeName="opacity" values="0;1;1;1;0" keyTimes="0;0.05;0.5;0.95;1" dur="76s" begin="72s" repeatCount="indefinite" />
              <foreignObject x="-14" y="-14" width="28" height="28">
                <div className="w-full h-full flex items-center justify-center">
                  <Sparkles className="w-6 h-6 text-cyan-300 drop-shadow-[0_0_10px_rgba(6,182,212,0.9)]" />
                </div>
