    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            onClick={onClick}
            className="fixed bottom-6 right-6 z-50 w-20 h-20 rounded-full bg-gradient-to-br from-primary via-secondary to-accent shadow-2xl shadow-primary/40 hover:shadow-primary/60 hover:scale-110 transition-all duration-500 group animate-bounce-subtle"
            aria-label="Converse com o KnowYOU"
          >
            {/* Múltiplos anéis de glow */}
            <div className="absolute inset-0 rounded-full bg-primary/20 blur-3xl animate-ping" />
            <div className="absolute inset-[-8px] rounded-full bg-primary/10 blur-2xl animate-pulse" />
