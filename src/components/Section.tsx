...
const Section = ({
  ...
  return <section id={id} className="py-8 relative">
      <div className="container mx-auto px-4">
        <div className={`grid lg:grid-cols-2 gap-8 items-center ${reverse ? "lg:flex-row-reverse" : ""}`}>
          <div className={`space-y-6 ${reverse ? "lg:order-2" : ""}`}>
            ...
            {quote && <div ref={quoteRef} className={`mt-6 pt-4 border-t border-border/30 transition-opacity duration-1000 ${isQuoteVisible ? 'opacity-100' : 'opacity-0'}`}>
