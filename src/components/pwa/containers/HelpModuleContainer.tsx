/**
 * ============================================================
 * HelpModuleContainer.tsx - v5.0.0
 * ============================================================
 * Container INDEPENDENTE do módulo Ajuda
...
export const HelpModuleContainer: React.FC<HelpModuleContainerProps> = ({ 
  onBack, 
  onHistoryClick,
  deviceId 
}) => {
    ...
    const fetchGreeting = async () => {
      try {
        ...
        if (error || !data?.greeting) {
          const configWelcome = (pwaConfig as any)?.helpWelcomeText;
