...
3. Selecione o projeto: **brasil-data-hub** (`geaaxpctnixwsppgttsm`)
...
**Value:**
```
[Cole aqui sua OpenAI API Key - obter em https://platform.openai.com/api-keys]
```
...
**Value:**
```
[Cole aqui sua Google Gemini API Key - obter em https://makersuite.google.com/app/apikey]
```
...
|-------------|--------------|--------|
| `OPENAI_API_KEY` | `[Sua OpenAI API Key]` | ⏳ Para você configurar |
| `GOOGLE_GEMINI_API_KEY` | `[Sua Gemini API Key]` | ⏳ Para você configurar |
